...
path = '/content/drive/MyDrive/AGST316_SP24_SharedGoogleDr/Python/Week 12/AWDN_ET_Memphis4N_2021.csv'
df = pd.read_csv(path)
###########
upload_files=st.file_uploader("Upload your CSV file", type=["csv"])
